                        ...
                        <div class="card-body">
                            <div class="offset-md-1 col-md-10 ">
                                <div class="card card-primary">
                                    <form role="form" action="{{ route('admin.product-category.update', $product_category->id) }}" method="POST"
                                        ...
                                        <div class="card-body row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="name" id="name" value="{{ $product_category->name ?? old('name') }}"
