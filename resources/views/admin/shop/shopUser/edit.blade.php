                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Shop User </h3>
                        ...
                        <div class="card-body">
                            <div class="offset-md-1 col-md-10 ">
                                <div class="card card-primary">
                                    <form role="form" action="{{ route('admin.shopUser.update', $shopUser->id) }}" method="POST"
                                        ...
                                        <div class="card-body row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="shop_id" id="shop_id" class="form-control select2" >
                                                    ...
                                                    @foreach ($shops as $shop)
                                                        <option value="{{ $shop->id }}" {{ $shop->id == $shopUser->shop_id ? "selected" : "" }}>
                                                            {{ $shop->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="username" id="username" value="{{ $shopUser->username ?? old('username') }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="email" name="email" id="email"  value="{{ $shopUser->email ?? old('email') }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="first_name" id="first_name" value="{{ $shopUser->first_name ?? old('first_name') }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="last_name" id="last_name" value="{{ $shopUser->last_name ?? old('last_name') }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="phone" id="phone"  value="{{ $shopUser->phone ?? old('phone') }}"
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                >{{ $shopUser->address ?? old('address') }}</textarea>
                                                @error('address')
                                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong> </span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <div id="preview_file" style="margin-top: 10px;">
                                                    @if ($shopUser->photo != null)
                                                        <img src="{{ file_url($shopUser->photo, 'shopUser') }}"
