                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="card-body">
                                        <form role="form" action="{{ route('admin.supplierPayment.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return formValidation()">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="balance" id="balance"  value="0" class="form-control @error('balance') is-invalid @enderror" placeholder="Supplier Due Balance"  min="0" step="any" readonly required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="amount" id="amount"  value="0" class="form-control @error('amount') is-invalid @enderror" placeholder="Supplier Paid Amount"  min="0" step="any"  required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="note" id="note" class="form-control  @error('note') is-invalid @enderror" placeholder="Supplier Payment Note" rows="3"></textarea>
