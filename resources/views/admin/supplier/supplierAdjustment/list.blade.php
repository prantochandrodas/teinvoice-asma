...
@section('content')
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Supplier Adjustment List</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
            <li class="breadcrumb-item active">Supplier Adjustment List</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Supplier Adjustment List </h3>
                        <a href="{{  route('admin.supplierAdjustment.index')  }}" class="btn btn-success float-right">
                            <i class="fa fa-pencil-alt"></i> Supplier Adjustment Form
                        </a>
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header bg-primary">
                      <h4 class="modal-title">View Supplier Adjustment </h4>
    ...
    window.onload = function(){
        ...
        function load_data(supplier_id = '',  from_date = '', to_date = ''){
            ...
            var table = $('#yajraDatatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url:'{!! route('admin.supplierAdjustment.getSupplierAdjustmentList') !!}',
                    data:{
        ...
        $('#yajraDatatable').on('click', '.view-modal', function(){
            var supplier_adjustment_id = $(this).attr('supplier_adjustment_id');
            var url = "{{ route('admin.supplierAdjustment.show', ":supplier_adjustment_id") }}";
            url = url.replace(':supplier_adjustment_id', supplier_adjustment_id);
            $('#showResult').html('');
            if(supplier_adjustment_id.length != 0){
                $.ajax({
                    cache   : false,
                    type    : "GET",
