                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="card-body">
                                        <form role="form" action="{{ route('admin.supplierAdjustment.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return formValidation()">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="note" id="note" class="form-control  @error('note') is-invalid @enderror" placeholder="Supplier Adjustment Note" rows="3"></textarea>
