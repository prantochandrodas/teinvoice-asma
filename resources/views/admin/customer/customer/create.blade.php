                                  ...
                                  @csrf
                                    <div class="card-body row">
                                        <div class="form-group col-md-6">
                                            ...
                                            class="form-control @error('username') is-invalid @enderror" placeholder="Enter User Name" autocomplete="off" required >
                                            @error('username')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="first_name" id="first_name" value="{{ old('first_name') }}"
                                                class="form-control @error('first_name') is-invalid @enderror" placeholder="Enter First Name" autocomplete="off" required >
                                            @error('first_name')
                                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong> </span>
                                            @enderror
                                        </div>
