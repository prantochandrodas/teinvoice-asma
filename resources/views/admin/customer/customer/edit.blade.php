                                    ...
                                    <form role="form" action="{{ route('admin.customer.update', $customer->id) }}" method="POST"
                                        ...
                                        <div class="card-body row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="first_name" id="first_name" value="{{ $customer->first_name ?? old('first_name') }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="last_name" id="last_name" value="{{ $customer->last_name ?? old('last_name') }}"
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <div id="preview_file" style="margin-top: 10px;">
                                                    @if ($customer->photo != null)
                                                        <img src="{{ file_url($customer->photo, 'customer') }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="nid_number" id="nid_number"  value="{{ $customer->nid_number ??  old('nid_number') }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div id="preview_file_nid_photo" style="margin-top: 10px;">
                                                    @if ($customer->nid_photo != null)
                                                        <img src="{{ file_url($customer->nid_photo, 'customer') }}"
                                                ...
                                                <select name="country_id" id="country_id" class="form-control select2" style="width: 100%">
                                                  <option value="0">Select Country</option>
                                                    @foreach ($countries as $country)
                                                        <option value="{{ $country->id }}" {{ $customer->country && $customer->country->id == $country->id ? "selected" : "" }}>
                                                            {{ $country->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="division_id" id="division_id" class="form-control select2" style="width: 100%">
                                                    ...
                                                    @foreach ($divisions as $division)
                                                        <option value="{{ $division->id }}" {{ $customer->division && $customer->division->id == $division->id ? "selected" : ""}}>
                                                            {{ $division->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
