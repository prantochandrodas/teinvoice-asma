            ...
            <div class="col-md-12">
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('message.create_new_role') }} ({{__('message.create_new_role', [], $secondary_locale)}})</h3>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="custom-control custom-checkbox">
                                                            <input
                                                                ...
                                                                >
                                                            <label for="{{ $loop->iteration }}-management" class="custom-control-label text-capitalize">{{ $group->name }}</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-9 role-{{ $loop->iteration }}-management-checkbox">
