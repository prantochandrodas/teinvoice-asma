                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">{{ __('message.edit') }} {{ __('message.admin') }} ({{__('message.edit', [], $secondary_locale)}} {{__('message.admin', [], $secondary_locale)}})</h3>
                                    ...
                                    <form role="form" action="{{ route('admin.admin.update', $admin->id) }}" method="POST"
                                        ...
                                        <div class="card-body row">
                                            <div class="form-group col-md-6">
                                                ...
                                                class="form-control @error('name') is-invalid @enderror" placeholder="{{ __('message.enter_username') }} ({{__('message.enter_username', [], $secondary_locale)}})" required>
                                                @error('username')
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="email" name="email" id="email"  value="{{ $admin->email ?? old('email') }}"
                                                    class="form-control @error('email') is-invalid @enderror"  placeholder="{{ __('message.enter_email') }} ({{__('message.enter_email', [], $secondary_locale)}})" required>
                                                @error('email')
                                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong> </span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="last_name">{{ __('message.last_name') }} ({{__('message.last_name', [], $secondary_locale)}})<code>*</code>  </label>
                                                <input type="text" name="last_name" id="last_name" value="{{ $admin->last_name ?? old('last_name') }}"
                                                    class="form-control @error('last_name') is-invalid @enderror" placeholder="{{ __('message.last_name') }} ({{__('message.last_name', [], $secondary_locale)}})" required>
                                                @error('last_name')
                                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong> </span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="password">{{ __('message.password') }}  ({{__('message.password', [], $secondary_locale)}})</label>
                                                <input type="password" name="password" id="password" value="{{ old('password') }}"
                                                    class="form-control @error('password') is-invalid @enderror" placeholder="{{ __('message.password') }} ({{__('message.password', [], $secondary_locale)}})" >
                                                @error('password')
                                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong> </span>
                                                @enderror
                                            </div>
