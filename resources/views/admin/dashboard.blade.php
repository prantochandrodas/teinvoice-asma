        ...
        <div class="container-fluid">
            <div class="row" >
                ...
                <div class="col-lg-5 col-sm-12">
                    <form role="form" action="{{ route('admin.sale.store') }}"
                        method="POST" enctype="multipart/form-data" .
                        onsubmit="return formSaleValidation()"
                        id="saleForm">
                        @csrf
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <select name="search_sale_id" id="search_sale_id" class="form-control select2"
                                            data-placeholder="Select an Sale Bill"
                                            data-tags="true"
                                ...
                                <div class="col-md-2 mt-3">
                                    <button type="button"  id="invoice_print"
								...
								<div class="col-md-6">
                                    ...
                                    <select name="bill_type" id="bill_type" class="form-control select2"
                                        data-placeholder="Select an Bill Type"
                                        data-tags="true"
                                        data-allow-clear="true"> 
                            ...
                            <div id="sale_information_div">
                                <div class="row" >
                                    ...
                                    <div class="col-md-4" style="margin-top: 5px" >
                                        ...
                                        <select name="branch_id" id="branch_id" class="form-control select2"  data-placeholder="Select an Branch"    data-tags="true"
                                        data-allow-clear="true">
                                            <option></option>
                                    ...
                                    <div class="col-md-9" style="margin-top: 5px">
                                        ...
                                        <input  style="background-color:#FFD700;" type="text"
                                        name="bar_code" id="bar_code" value="" class="form-control" placeholder="Scan Your Bar Code.." autofocus/>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2" style="margin-top: 5px">
                                                <button type="button" class="btn btn-success btn-block" id="item_add_button">
                                                    {{ __('message.add') }}
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3" style="margin-top: 5px">
                                        <label for="total_tax_amount">{{ __('message.tax_amount') }} ({{ $application->vat_percent }}%)</label>
                                        </div>
                                    <div class="col-md-3" style="margin-top: 5px">

                                        <input type="text" name="total_tax_amount" id="total_tax_amount"
                                            value="{{ old('total_tax_amount') }}"
                                            class="form-control "
                                            readonly
                                    ...
                                    <div class="col-md-12 text-center" style="margin-top: 5px">
                                        ...
                                        <input type="radio" id="Cash" name="payment_type" value="Cash" checked="checked">
                ...
                <div class="col-lg-7 col-sm-12" >
                    <div class="row" style="padding: 10px;">
                        <div class="col-md-12 text-left">
                            ...
                            <input type="checkbox"
                                ...
                                data-on-text="{{ __('message.yes') }}"
                                data-off-text="{{ __('message.no') }}"
                    ...
                    <div class="row" style="padding: 2px; max-height: 750px; overflow-y: scroll">
                        <div class="" style="max-height: 100px; height: 80px; padding: 2px; width:132px; margin:2px">
                        ...
                        @php
                            $color_array = [
                                "1266F1","B23CFD","00B74A","F93154","39C0ED","262626"
                            ];
                            $colorNumber = 0;
                        @endphp
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body" id="showResult">
                <div class="row" style="padding: 10px;">
                    <div class="col-md-12 text-right">
                        @if (auth_admin_user_permission('item.create'))
                            <a href="{{ route('admin.item.create') }}" target="_blank" class="btn btn-success float-right">
                ...
                <form role="form" action="{{ route('admin.easySaleItem.update') }}"
                    method="POST" enctype="multipart/form-data" .
                    onsubmit="return formEasySaleValidation()">
                    @csrf
                                ...
                                <tr>
                                    <th class="text-center">
                                        <div class="custom-control custom-radio text-center">
                                            ...
                                            id="item_id{{ $item->id }}" name="item_id" value="{{ $item->id }}">
