        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <form role="form" action="{{ route('admin.purchase.store') }}"
                                method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <table class="table ">
                                                <tr>
                                                    <th >Invoice No </th>
                                                    <td colspan="2">
                                                        <input type="text" name="invoice_no" id="invoice_no" placeholder="Purchase Invoice No" class="form-control @error('invoice_no') is-invalid @enderror" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 5%"> : </td>
                                                    <td style="width: 55%">
                                                        <span id="view_supplier_name">Not Confirm</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="width: 5%"> : </td>
                                                    <td style="width: 55%">
                                                        <span id="view_supplier_contact_number">Not Confirm</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="width: 5%"> : </td>
                                                    <td style="width: 55%">
                                                        <span id="view_supplier_address">Not Confirm</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3">
                                                        <textarea name="note" id="note" class="form-control  @error('note') is-invalid @enderror" placeholder="Purchase Note "></textarea>
                                        ...
                                        <div class="col-md-6">
                                            <table class="table ">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 5%"> : </td>
                                                    <td style="width: 55%">
                                                        <input type="number" name="discount_amount"  id="discount_amount" placeholder="Discount Amount" value="0" class="form-control  @error('discount_amount') is-invalid @enderror"  required style="text-align: right;">
