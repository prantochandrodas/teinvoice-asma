...
<div class="content-header">
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
        <h1 class="m-0 text-dark">Generate Delivery Branch Transfer Update  (Trip) </h1>
        </div>
        <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('branch.home') }}">Home</a></li>
            <li class="breadcrumb-item active">Generate Delivery Branch Transfer Update  (Trip) </li>
        </ol>
        </div>
    </div>
    </div>
  ...
  <div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form role="form" action="{{ route('branch.parcel.confirmDeliveryBranchTransferGenerateEdit', $deliveryBranchTransfer->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return createForm()">
                    @method('patch')
                    @csrf
                        ...
                        <div class="col-md-12">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <table class="table ">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 5%"> : </td>
                                                <td style="width: 55%">
                                                    <span id="view_branch_name">{{ $deliveryBranchTransfer->to_branch->name }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 5%"> : </td>
                                                <td style="width: 55%">
                                                    <span id="view_branch_contact_number">{{ $deliveryBranchTransfer->to_branch->contact_number }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 5%"> : </td>
                                                <td style="width: 55%">
                                                    <span id="view_branch_address">{{ $deliveryBranchTransfer->to_branch->address }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <div class="col-md-6">
                                        <fieldset id="div_delivery_branch_transfer_parcel"  >
                                            ...
                                            @foreach($deliveryBranchTransfer->delivery_branch_transfer_details as $delivery_branch_transfer_detail)
                                                <tr style="background-color: #f4f4f4;">
                                                    <td class="text-center" >
                                                        <input type="checkbox" id="checkItem"  class="parcelId"  value="{{ $delivery_branch_transfer_detail->parcel->id }}" >
                                                    </td>
                                                    <td class="text-center" >
                                                    ...
                                                    <td class="text-center" >
                                                        {{ $delivery_branch_transfer_detail->parcel->customer_name }}
                                                    </td>
                                                    <td class="text-center" >
                                                        {{ $delivery_branch_transfer_detail->parcel->customer_contact_number }}
                                                    </td>
                                                    <td class="text-center" >
                                                        {{ $delivery_branch_transfer_detail->parcel->district->name }}
                                                    </td>
                                                    <td class="text-center" >
                                                        {{ $delivery_branch_transfer_detail->parcel->area->name }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endif --}}
...
<script>
    $("#branch_id").val('{{ $deliveryBranchTransfer->to_branch_id }}').change();
